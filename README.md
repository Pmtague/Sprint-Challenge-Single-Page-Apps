...
> Answer: Client side routing is faster and keeps us from having to grab website info from the server more than once.
- [ ] What does AJAX stand for?
> Answer: Asyncronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: In controlled components, we take over the handling of state from the html elements.
- [ ] Name three tools/libraries for making AJAX requests.
> Answer: Axios, Fetch, Superagent
